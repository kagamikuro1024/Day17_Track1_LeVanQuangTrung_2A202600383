---
title: Bạn là Agent đa nhân cách.md؆؆؆
source: Day17-AI-Product-Handbook.pdf
pages: 26
converted_at: 2026-04-24T09:34:01.757236
---
...
Một chiến lược tuyệt vời vẫn có thể chết gục ở khâu thực thi nếu không biết chính xác
phải build gì trước.
0. Cách dùng sổ tay này
Dùng trong lúc làm workshop — không phải để đọc hết một lượt. Mỗi lần bí, mở đúng
phần cần:
Khi bạn cần… Mở phần…
Hiểu mạch logic tổng thể §1
Đọc nhanh một khái niệm §2
...
Chuẩn bị bản nộp cuối buổi §7 (Final submission)
Đọc tham khảo sâu hơn §8 (References)
Quy ước ngôn ngữ: Tiếng Việt ưu tiên. Các term, công thức, prompt giữ tiếng Anh để
không lệch nghĩa khi làm việc với AI.

| Workshop | Tầng | Câu hỏi chính | Output |
| --- | --- | --- | --- |
| WS1 — MVP
Boundary | 3 & 4 | Build gì trước, bỏ gì lại? | MVP Boundary Sheet |
| WS2 — PRD
Skeleton | 5 | Định nghĩa quyết định sản
phẩm thế nào? | PRD Skeleton |
| WS3 — Hypothesis
& PMF | 6 | Đo lường thành công bằng
số nào? | Hypothesis Table + PMF
Scorecard |

1. Mạch logic Day 17
Day 17 tiếp nối trực tiếp từ Day 16. Nếu Day 16 xây 2 tầng nền (Market), thì Day 17 xây 4
tầng trên (Product) của Lean Product Pyramid.
...
(cid:0) [Day 17] (cid:0)
(cid:0) Tầng 6: Test with Customers (cid:0) (cid:0) Workshop 3
(cid:0) Tầng 5: UX & Prototype (cid:0) (cid:0) Workshop 2
(cid:0) Tầng 4: Feature Set (cid:0) (cid:0) Workshop 1
(cid:0) Tầng 3: Value Proposition (cid:0) (cid:0) Workshop 1
(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)
(cid:0) [Day 16 — ĐÃ XONG] (cid:0)
(cid:0) Tầng 2: Underserved Needs (cid:0)
(cid:0) Tầng 1: Target Customer (cid:0)
(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)
Lean Product Pyramid
— Dan Olsen
Nguyên tắc không đổi: Không xây nhà từ nóc. Mọi tính năng trong Day 17 phải phục vụ
đúng Customer và Need đã xác định ở Day 16.
### Ba workshop và đầu ra
Workshop Tầng Câu hỏi chính Output
WS1 — MVP
3 & 4 Build gì trước, bỏ gì lại? MVP Boundary Sheet
Boundary
### WS2 — PRD Định nghĩa quyết định sản
5 PRD Skeleton
### Skeleton phẩm thế nào?
WS3 — Hypothesis Đo lường thành công bằng Hypothesis Table + PMF
6
& PMF số nào? Scorecard
...
| --- | --- | --- |
| Wizard of Oz
MVP | Khi rủi ro lớn nhất là “khách
có mua không?” | Zappos (1999): chụp ảnh giày, đăng
web, tự đi mua ship |
| Explainer
Video MVP | Khi rủi ro lớn nhất là “khách
có hiểu giá trị không?” | Dropbox (2008): video 3 phút,
waitlist từ 5k (cid:0) 75k người |
| Landing Page
MVP | Khi rủi ro lớn nhất là “khách
có trả tiền không?” | Buffer (2010): bảng giá giả, chờ
người click “Mua” rồi mới code |

| Khái
niệm | Định nghĩa | Tại sao quan trọng |
| --- | --- | --- |
| In-Scope | Tính năng cốt lõi bắt buộc phải có để test giả
thuyết | Thiếu 1 tính năng này (cid:0)
không test được |
| Out-of-
Scope | Tính năng tốt, nhưng không cần cho MVP | Làm thêm thứ này = lãng
phí thời gian build |
| Non-
Goals | Ranh giới đỏ — thứ sản phẩm sẽ không bao
giờ làm (ít nhất trong giai đoạn này) | Giữ focus, tránh scope
creep trong team |

MVP không phải là sản phẩm bị lột bỏ tính năng. MVP là bài test rẻ nhất để mua sự
thật từ thị trường.
The goal of an MVP is not to build the smallest product — it’s to learn the most with
the least effort.
3 dạng MVP phổ biến không cần code:
Loại MVP Khi nào dùng Ví dụ kinh điển
Wizard of Oz Khi rủi ro lớn nhất là “khách Zappos (1999): chụp ảnh giày, đăng
MVP có mua không?” web, tự đi mua ship
Explainer Khi rủi ro lớn nhất là “khách Dropbox (2008): video 3 phút,
Video MVP có hiểu giá trị không?” waitlist từ 5k (cid:0) 75k người
Landing Page Khi rủi ro lớn nhất là “khách Buffer (2010): bảng giá giả, chờ
MVP có trả tiền không?” người click “Mua” rồi mới code
Quy tắc vàng: Trước khi viết code, hãy xác định giả định rủi ro nhất (Riskiest
Assumption) và tìm cách test nó với chi phí thấp nhất.
2.2 MVP Boundary — Ranh giới MVP
Ba khái niệm bắt buộc phải xác định trước khi build:
Khái
Định nghĩa Tại sao quan trọng
niệm
Tính năng cốt lõi bắt buộc phải có để test giả Thiếu 1 tính năng này (cid:0)
In-Scope
thuyết không test được
Out-of- Làm thêm thứ này = lãng
Tính năng tốt, nhưng không cần cho MVP
Scope phí thời gian build
Non- Ranh giới đỏ — thứ sản phẩm sẽ không bao Giữ focus, tránh scope
Goals giờ làm (ít nhất trong giai đoạn này) creep trong team
Kill question cho MVP Boundary:
Nếu cắt thêm 1 tính năng nữa trong In-Scope, khách hàng có còn nhận được giá trị
cốt lõi không?
CÓ
Nếu (cid:0) tính năng đó phải chuyển sang Out-of-Scope. MVP vẫn đang quá béo.
...
Instagram: Cắt 90% tính năng của Burbn, chỉ giữ lại Chụp ảnh (cid:0) Filter (cid:0) Share. Kết
quả: tỷ đô.
Slack: Vứt bỏ cả một tựa game (Glitch), chỉ giữ lại công cụ chat nội bộ team vẫn
dùng hàng ngày.
Figma: Không cố copy Adobe. Dồn 100% vào đúng 1 tính năng đối thủ không có:
Multiplayer realtime.
2.3 PRD — Product Requirements Document
PRD là gì: Văn bản đồng thuận (Alignment Document) về “Cái gì” và “Tại sao” — không
phải “Làm thế nào”.
PRD không phải là:
...
| Privacy /
Compliance | Dữ liệu có được phép gửi lên cloud không? Có cần on-
premise? |
...
Ví dụ tốt: “As a bus operator manager, I want to receive a call summary after AI
handles a booking, so that I can review and fix any errors before confirming.”
...
Ghi rõ tại sao chọn model này thay vì các model khác. Không được chỉ viết “dùng GPT-
4o” mà không có lý do.
Trade-offs cần cân nhắc:
Yếu tố Câu hỏi cần trả lời
Accuracy vs Cost Model đắt hơn có thực sự cần thiết cho use-case này không?
Latency Ứng dụng cần phản hồi trong bao lâu? Real-time hay async?
Context window Input của bạn dài bao nhiêu? Model có đủ context không?
Privacy / Dữ liệu có được phép gửi lên cloud không? Có cần on-
Compliance premise?
Fine-tuned vs RAG Cần fine-tune riêng hay RAG từ knowledge base là đủ?
...
Trong phần mềm truyền thống, nút bấm luôn làm đúng những gì bạn bảo. Trong AI,
bạn phải thiết kế cho cả lúc nó làm sai.
...
Cách dùng: Hiệu quả nhất khi rủi ro sai còn ở mức chấp nhận được (text
generation, summarization).
Chiến lược 2 — Human-in-the-loop:
AI không tự động thay đổi data thật — luôn cần user xác nhận bước cuối.
Ví dụ: Notion AI hiển thị kết quả trong khối tạm thời màu tím. User phải bấm
“Keep”, “Try again”, hoặc “Discard”.
Cách dùng: Khi AI có thể thay đổi dữ liệu quan trọng (viết lại văn bản, sửa code,
thay đổi cấu hình).
Chiến lược 3 — Graceful Handover:
Khi AI không tự tin, hệ thống tự động chuyển quyền kiểm soát về cho con người.
Ví dụ: Tesla Autopilot cảnh báo và yêu cầu tài xế cầm vô lăng khi mất tín hiệu vạch
kẻ đường.
Cách dùng: Khi rủi ro cao (hệ thống tự lái, y tế, tài chính), hoặc khi confidence score
của model dưới ngưỡng.
...
Mọi tính năng trong PRD đều là một vụ cá cược. Hypothesis Testing là cách ghi rõ điều
kiện thắng/thua của từng cược đó.
...
Trong tất cả các giả định ngầm đằng sau PRD của bạn, hãy tìm ra cái nguy hiểm nhất —
giả định mà nếu sai thì toàn bộ dự án sụp đổ — và test nó trước tiên.
Cách xác định Riskiest Assumption:
1. Liệt kê tất cả giả định đằng sau sản phẩm (user behavior, willingness to pay,
...
PMF không phải là cảm giác. PMF là khi có đủ bằng chứng định lượng rằng sản phẩm
đang giải quyết đúng vấn đề cho đúng người.
Ba cách đo PMF
Cách 1 — Sean Ellis Test (40% Rule):
Hỏi người dùng hiện tại: “Bạn sẽ cảm thấy thế nào nếu không còn dùng được sản phẩm này
nữa?”
...
Ngưỡng PMF: Nếu >40% trả lời “Very disappointed” (cid:0) có dấu hiệu PMF.
Cách dùng kết quả để improve PMF (như Superhuman):
Bỏ qua nhóm “Not disappointed” (họ không phải khách hàng mục tiêu)
Phân tích nhóm “Very disappointed”: họ yêu gì nhất? (cid:0) Dồn lực vào đó
Phân tích nhóm “Somewhat disappointed”: họ thiếu gì để chuyển sang “Very
disappointed”? (cid:0) Build thứ đó
Cách 2 — Retention Curve:
Vẽ đồ thị % người dùng vẫn còn active theo thời gian (cohort analysis).
100% (cid:0)(cid:0)
(cid:0) \
(cid:0) \
40% (cid:0)(cid:0) '(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0) (cid:0) Flattening = PMF signal
(cid:0)
0% (cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0)(cid:0) Thời gian (ngày/tuần/tháng)
Đường cong cắm thẳng xuống 0: Không có PMF. Người dùng thử rồi bỏ hết.
Đường cong đi ngang (flatten): Có PMF. Một tỷ lệ người dùng đã hình thành thói
quen.
Ngưỡng tham khảo:
...
Tìm ra hành vi cụ thể mà những người dùng giữ lại lâu dài đều thực hiện trong những
ngày đầu.
Sản phẩm Magic Number / Aha Moment
Facebook Kết bạn với 7 người trong 10 ngày đầu
Twitter Follow 30 người
...
| Vanity Metrics (cid:0) | Actionable Metrics (cid:0) |
| --- | --- |
| Số lượt tải app | D30 Retention Rate |
| Tổng lượt đăng ký | % User hoàn thành onboarding |
| Lượt xem trang | Conversion rate từ visit (cid:0) action |
...
### 1. Chia user thành 2 nhóm: “Retained users” (dùng lâu dài) và “Churned users” (bỏ
### sớm)
### 2. So sánh hành vi 7–14 ngày đầu của 2 nhóm
### 3. Tìm hành vi mà “Retained users” làm nhiều hơn “Churned users” — đó là Aha
### Moment candidate
### 4. Verify bằng cách build feature để ép user mới đạt được hành vi đó sớm hơn (cid:0) đo
### retention
### 2.7 Actionable Metric vs Vanity Metric
### Vanity Metric (Chỉ số ảo): Con số trông đẹp nhưng không cho biết sản phẩm đang tốt
### lên hay tệ đi về mặt thực chất.
### Actionable Metric (Chỉ số hành động): Con số gắn trực tiếp với hành vi tạo ra giá trị —
### khi con số này tốt lên, product thực sự tốt hơn.
### Test để phân biệt:
...
### Revenue tổng Revenue per active user (ARPU)
DAU/MAU tổng DAU/MAU ratio (stickiness)
### North Star Metric: Một con số duy nhất phản ánh tốt nhất việc sản phẩm đang tạo ra
### giá trị cho user. Mọi team đều nên biết North Star của mình.
...
một thứ
Trả lời câu hỏi: Nếu sản phẩm của tôi chỉ làm được — thứ đó là gì?
...
(cid:0) ___________________________________________
(cid:0) ___________________________________________
(cid:0) ___________________________________________
OUT-OF-SCOPE
(Tính năng tốt nhưng không cần cho MVP)
...
1. Nếu cắt thêm 1 tính năng trong In-Scope, khách hàng còn nhận được giá trị cốt lõi
không?
(cid:0) Nếu có (cid:0) tính năng đó thuộc Out-of-Scope.
2. In-Scope của bạn có nhiều hơn 3 tính năng không?
(cid:0) Nếu có (cid:0) bạn chưa sắc. Cắt tiếp.
3. Non-Goals của bạn có ít nhất 1 thứ mà team đang rất muốn làm không?
(cid:0) Nếu không (cid:0) Non-Goals chưa thật.
...
Ví dụ tốt: “Nhà xe vừa nhỏ đang mất 15–20% cuộc gọi đặt vé trong giờ cao điểm vì không đủ
nhân sự trực tổng đài — mỗi cuộc gọi nhỡ là một lần mất doanh thu.”
...
1. Nếu một kỹ sư đọc 2 User Stories này, họ có cần hỏi lại hơn 3 câu để bắt đầu code
không?
(cid:0) Nếu có (cid:0) User Stories còn mơ hồ.
2. Fallback UX của bạn có mô tả cụ thể trigger và hành động không?
(cid:0) “Khi AI không tự tin” là chưa đủ. Phải là “Khi confidence score < 80% hoặc khi

response chứa X pattern.”
3. Model Selection Rationale có giải thích trade-off không?
(cid:0) “Dùng GPT-4o vì nó tốt” là không đủ.
...
Lưu ý:
Giống Day 16, tất cả prompt giữ tiếng Anh 100% để AI giữ ngữ nghĩa ổn định.
Thảo luận kết quả bằng tiếng Việt.
...
| --- | --- | --- |
| Nộp khi
nào | Cuối buổi sáng Day 17 (trước 13:00) | Trước 23:59 cùng ngày Day 17 |
| Nộp ở
đâu | Submit trực tiếp trên LMS | Submit link public GitHub lên LMS |
| Bao
gồm | MVP Boundary + PRD Skeleton +
Hypothesis/PMF (bản nháp) | Bản hoàn chỉnh hơn trong
submission.md trên GitHub |
...
Minimum bar: Nếu một kỹ sư đọc PRD của bạn, họ phải hiểu được: build cái gì, tại sao,
AI làm gì khi sai, và thành công trông như thế nào — mà không cần hỏi lại hơn 3 câu.
6. Rubric & Submission
6.1 Cách nộp bài — 2 phiên bản bắt buộc
Phiên bản A — End-of-session Phiên bản B — BTVN
Nộp khi
Cuối buổi sáng Day 17 (trước 13:00) Trước 23:59 cùng ngày Day 17
nào
Nộp ở
Submit trực tiếp trên LMS Submit link public GitHub lên LMS
đâu
Bao MVP Boundary + PRD Skeleton + Bản hoàn chỉnh hơn trong
gồm Hypothesis/PMF (bản nháp) submission.md trên GitHub
Lưu ý:
Phiên bản A là snapshot tư duy tại thời điểm cuối buổi. Không chỉnh A sau khi
đã nộp — A dùng để đo mức độ cải thiện sang B.
...
Mức độ sắc bén của toàn bộ product logic: MVP Boundary có thực sự cắt đến mức cần
thiết chưa? In-Scope có đủ focused không? Non-Goals có thực sự là ranh giới đỏ không?
PRD có phản ánh đúng Customer và Need từ Day 16 không?
Điểm cao nhất dành cho bài có thể trả lời: “Tại sao mỗi tính năng trong In-Scope là bắt buộc
và không thể cắt thêm.”
Tiêu chí 2 — AI Design Rigor (20 điểm)
Chấm chất lượng của 3 thành phần AI-specific trong PRD. Model Selection Rationale có
giải thích trade-off thực sự không, hay chỉ ghi tên model? Data Requirements có xác định
được nguồn cụ thể không? Fallback UX có trigger và hành động cụ thể không, hay chỉ là
“hiện thông báo lỗi”?
Tiêu chí này phân biệt người hiểu AI product design với người chỉ copy template.
Tiêu chí 3 — Measurement Quality (15 điểm)
Hypothesis có viết đúng công thức không? Aha Moment có được xác định bằng hành vi
cụ thể không? Metric được chọn có thực sự là Actionable Metric không, hay là Vanity
Metric ngụy trang? PMF method có phù hợp với loại sản phẩm không?
Tiêu chí 4 — Story Consistency (10 điểm)
PRD Day 17 có nhất quán với Day 16 Package không? Target User trong PRD có khớp với
Customer Segment Card không? Problem Statement có gắn với Need Map không?
Success Metrics có gắn với Value Proposition không?
Tiêu chí 5 — Iteration Quality (20 điểm)
Mức độ cải thiện thực sự giữa A và B. Thưởng người dám sửa core element (MVP scope,
Fallback strategy, Hypothesis metric) sau khi nhận AI critique — không chỉ polish văn
phong.
Điểm Outstanding dành cho bài B vượt hẳn kỳ vọng so với A, kèm reflection honest về điều gì
đã thay đổi và tại sao.
6.3 Grade bands
Band Điểm Ý nghĩa

| Outstanding | 90–
100 | Output vượt template — PRD có insight riêng, Fallback UX thể
hiện tư duy sản phẩm vượt guideline |
| --- | --- | --- |
| Strong | 75–89 | Đủ chất để bắt đầu build, không cần revise mắt xích nào |
| Pass | 60–74 | Build được nhưng cần clarify ít nhất 1 phần trước khi giao cho
engineer |
| Needs
rework | 40–59 | PRD còn quá mơ hồ để build, cần làm lại AI-specific section
hoặc Hypothesis |
| Fail | <40 | Chưa đạt minimum bar của Day 17 |

90– Output vượt template — PRD có insight riêng, Fallback UX thể
Outstanding
100 hiện tư duy sản phẩm vượt guideline
Strong 75–89 Đủ chất để bắt đầu build, không cần revise mắt xích nào
Build được nhưng cần clarify ít nhất 1 phần trước khi giao cho
Pass 60–74
engineer
Needs PRD còn quá mơ hồ để build, cần làm lại AI-specific section
40–59
rework hoặc Hypothesis
Fail <40 Chưa đạt minimum bar của Day 17
6.4 Lưu ý khi làm bài
Cụ thể hơn là đầy đủ. Một Fallback UX mô tả rõ 1 scenario tốt hơn 3 scenario viết
chung chung.
Mỗi thứ trong In-Scope phải map được về 1 Need cụ thể từ Day 16. Nếu không
map được — đó là scope creep.
Hypothesis phải sai được. Nếu bạn không thể nghĩ ra cách Hypothesis này bị
falsified — nó quá mơ hồ.
AI critique chỉ có ý nghĩa nếu bạn quyết định điều gì accept và điều gì reject.
Nộp bài mà không có reflection về AI feedback = chưa dùng AI đúng cách.
7. Final submission — Day 17 Package
Copy template dưới đây vào submission.md trong GitHub repo, điền đầy đủ.
# Day 17 Submission
**Student:** [Tên]
**Date:** [Ngày]
**Product idea:** [1 câu mô tả ý tưởng]
---
## 1. MVP Boundary Sheet
**Riskiest Assumption:**
> [1 câu — giả định nguy hiểm nhất cần test]

**In-Scope** (tối đa 3):
- [ ] [Tính năng 1] — test giả định: [...]
- [ ] [Tính năng 2] — test giả định: [...]
**Out-of-Scope:**
- [Tính năng A] — lý do bỏ: [...]
- [Tính năng B] — lý do bỏ: [...]
- [Tính năng C] — lý do bỏ: [...]
**Non-Goals:**
- [Ranh giới đỏ 1]
- [Ranh giới đỏ 2]
---
...
### Target User
> [Chân dung cụ thể — nối từ Customer Segment Card Day 16]
### User Stories
**Story 1:**
> As a [...], I want [...], so that [...]
**Story 2:**
...
- Update frequency: [...]
**Fallback UX:**
- Chiến lược: [Expectation Management / Human-in-the-loop / Graceful Handover]
- Trigger: [Khi nào AI bị coi là không đủ tự tin?]
- Hành động: [Hệ thống làm gì cụ thể?]
- User options: [User có thể làm gì tiếp theo?]
### Success Metrics
- Primary metric: [...]
- Ngưỡng thành công: [...]
- Timeframe đo lường: [...]
...
> "Chúng tôi tin rằng [X] sẽ giúp [Y] đạt được [Z].
...
**PMF Method:**
> [Sean Ellis / Retention Curve / Aha Moment tracking]
> Ngưỡng thành công: [...]
...
## 5. AI Critique Log
**Điểm AI chỉ ra:**
1. [Issue 1] — Action: Accept / Reject / Partial — Lý do: [...]
2. [Issue 2] — Action: Accept / Reject / Partial — Lý do: [...]
3. [Issue 3] — Action: Accept / Reject / Partial — Lý do: [...]
**Thay đổi lớn nhất giữa Version A và Version B:**
> [Mô tả điều gì thay đổi và tại sao]
---
## 6. Self-assessment
Mắt xích nào trong [MVP Boundary (cid:0) PRD (cid:0) Hypothesis (cid:0) PMF] bạn đang yếu nhất?
> [Trả lời thật]
...
| “In traditional software, a button does what it’s told. In AI, you must design for when it
disobeys.” |

1. The Lean Product Playbook — Dan Olsen
https://leanproductplaybook.com/
Framework gốc của Lean Product Pyramid. Chương 4–7 là phần liên quan trực tiếp
nhất cho Day 17.
2. How Superhuman Built an Engine to Find Product Market Fit — Rahul Vohra
https://review.firstround.com/how-superhuman-built-an-engine-to-find-product-
market-fit
Bài viết gốc về PMF Engine và Sean Ellis Test được áp dụng vào thực tế.
3. The Mom Test — Rob Fitzpatrick
Cách phỏng vấn user để validate hypothesis mà không bị “mom answer” làm lệch
kết quả.
Further reading (optional)
4. Writing Good PRDs — Jackie Bavaro & Gayle Laakmann McDowell (Cracking the PM
Interview)
Hướng dẫn viết PRD từ góc nhìn PM chuyên nghiệp.
5. Measure What Matters — John Doerr
OKR framework — liên quan trực tiếp đến cách định nghĩa Success Metrics trong
PRD.
6. Inspired: How to Create Tech Products Customers Love — Marty Cagan
Tư duy product management chuyên sâu từ người từng làm VP Product tại eBay và
HP.
7. Shape Up — Ryan Singer (Basecamp)
https://basecamp.com/shapeup
Phương pháp scope sản phẩm thực chiến — liên quan đến MVP Boundary và PRD
Skeleton.
...
| “Don’t measure the busyness of the system, measure the behavior that creates core
value.” |
| “If a metric goes up but core behavior doesn’t change — it’s a vanity metric.” |
| “A hypothesis must be falsifiable. If you can’t imagine how it could be wrong — it’s too
vague.” |
